...
function createDemo(panel: Panel): void {
  ...
  panel.pieces = [
    { id: 1, kind: 'cube3', ...{ prefabUuid: ref('cube3').uuid, prefabUrl: ref('cube3').url }, axis: 'Z', angle: 0, anchor: { x: 0, y: 1, z: 0 } },
    { id: 2, kind: 'cube4', ...{ prefabUuid: ref('cube4').uuid, prefabUrl: ref('cube4').url }, axis: 'Z', angle: 0, anchor: { x: 1, y: 1, z: 0 } },
    { id: 3, kind: 'cube3', ...{ prefabUuid: ref('cube3').uuid, prefabUrl: ref('cube3').url }, axis: 'X', angle: 90, anchor: { x: 4, y: 4, z: 1 } },
